...
const Sidebar = (props) => {
    ...
    return (
        <div className={`${props.className} bg-primary-200 h-screen px-2 md:px-4 xl:px-8 sticky top-0 left-0`}>
            <div className="min-h-full py-4 flex flex-col justify-between">

                <div className="hidden md:block text-lg font-bold text-center">ADMIN</div>
                <ul className="py-4 flex flex-col justify-start flex-1">
                    <li className=" cursor-pointer p-4 md:mt-6 hover:bg-primary-400 hover:text-white group flex justify-center custom-1:justify-start bg-white rounded-lg" onClick={() => navigate('/')}>
                        <svg className="w-6 h-6 custom-1:mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        <span className="duration-75 font-semibold hidden custom-1:block">Dashboard</span>
                    </li>
                    ...
                    <li className="cursor-pointer p-4 mt-6 hover:bg-primary-400 hover:text-white group flex justify-center custom-1:justify-start bg-white rounded-lg" onClick={() => navigate('/products')}>
                        ...
                        <span className="group-hover:ml-3 duration-75 font-semibold hidden custom-1:block">Products</span>
                    </li>
                ...
                <div className="cursor-pointer p-4 md:mb-6 hover:bg-primary-400 hover:text-white group flex justify-center custom-1:justify-start bg-white rounded-lg" onClick={onLogout}>
